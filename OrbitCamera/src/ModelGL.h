...
public:
    ...
    void setMouseLeft2(bool flag)           { mouseLeftDown2 = flag; };
    void setMouseRight(bool flag)           { mouseRightDown = flag; };
    void setMousePosition(int x, int y)     { mouseX = x; mouseY = y; };
    void setMousePosition2(int x, int y)    { mouseX2 = x; mouseY2 = y; };
    ...
    void rotateCamera2(int x, int y);
    void zoomCamera(int dist);
    void zoomCameraDelta(float delta);        // for mousewheel
    void zoomCameraDelta2(float delta);        // for mousewheel
    void resetCamera();
