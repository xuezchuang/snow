...
static void standard_defines(string& sources)
{
								...
								const char* shname)
{
	...
	//Shader* shader = new Shader(shname); //GPUBackend::get()->shader_alloc(shname);
...
/** \} */
 ...
 /***************************************************************************************************/
 /*						name Uniforms / Resource location											*/
 /***************************************************************************************************/
...
{
	const int loc = unwrap(sh)->GPU_shader_get_uniform(name);
