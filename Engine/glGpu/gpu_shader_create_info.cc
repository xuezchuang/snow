...
//typedef irr::core::map Map;
using CreateInfoDictionnary = irr::core::map<StringRef,ShaderCreateInfo*>;
using InterfaceDictionnary = irr::core::map<StringRef,StageInterfaceInfo*>;
...
#define GPU_SHADER_INTERFACE_INFO(_interface, _inst_name) \
	...
	CGpuShaderMgr::Instance()->set(#_interface, ptr_##_interface); \
	_interface

#define GPU_SHADER_CREATE_INFO(_info) \
	auto *ptr_##_info = new ShaderCreateInfo(#_info); \
	auto &_info = *ptr_##_info; \
	CGpuShaderMgr::Instance()->set(#_info, ptr_##_info); \
	_info
