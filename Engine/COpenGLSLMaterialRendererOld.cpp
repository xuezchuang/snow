...
//! Constructor
COpenGLSLMaterialRendererOld::COpenGLSLMaterialRendererOld(video::COpenGLDriverOld* driver,
...
{
#ifdef _DEBUG
	setDebugName("COpenGLSLMaterialRendererOld");
#endif
...
COpenGLSLMaterialRendererOld::COpenGLSLMaterialRendererOld(COpenGLDriverOld* driver,
													 IShaderConstantSetCallBack* callback,
...
//! Destructor
COpenGLSLMaterialRendererOld::~COpenGLSLMaterialRendererOld()
{
	if (CallBack)
		CallBack->drop();
...
void COpenGLSLMaterialRendererOld::init(s32& outMaterialTypeNr,
...
bool COpenGLSLMaterialRendererOld::OnRender(IMaterialRendererServices* service,
...
void COpenGLSLMaterialRendererOld::OnSetMaterial(const video::SMaterial& material,
											  const video::SMaterial& lastMaterial,
											  bool resetAllRenderstates,
											  video::IMaterialRendererServices* services)
{
	if (Driver->getFixedPipelineState() == COpenGLDriverOld::EOFPS_ENABLE)
		Driver->setFixedPipelineState(COpenGLDriverOld::EOFPS_ENABLE_TO_DISABLE);
	else
		Driver->setFixedPipelineState(COpenGLDriverOld::EOFPS_DISABLE);

	COpenGLCacheHandlerOld* cacheHandler = Driver->getCacheHandler();
...
void COpenGLSLMaterialRendererOld::OnUnsetMaterial()
{
	if (Program)
...
bool COpenGLSLMaterialRendererOld::isTransparent() const
{
	return (Alpha || Blending || FixedBlending);
}


bool COpenGLSLMaterialRendererOld::createProgram()
{
...
bool COpenGLSLMaterialRendererOld::createShader(GLenum shaderType, const char* shader)
{
	if (Program2)
	{
...
bool COpenGLSLMaterialRendererOld::linkProgram()
{
	if (Program2)
	{
...
void COpenGLSLMaterialRendererOld::setBasicRenderStates(const SMaterial& material,
...
s32 COpenGLSLMaterialRendererOld::getVertexShaderConstantID(const c8* name)
{
	return getPixelShaderConstantID(name);
}

s32 COpenGLSLMaterialRendererOld::getPixelShaderConstantID(const c8* name)
{
...
void COpenGLSLMaterialRendererOld::setVertexShaderConstant(const f32* data, s32 startRegister, s32 constantAmount)
{
	os::Printer::log("Cannot set constant, please use high level shader call instead.", ELL_WARNING);
}

void COpenGLSLMaterialRendererOld::setPixelShaderConstant(const f32* data, s32 startRegister, s32 constantAmount)
{
	os::Printer::log("Cannot set constant, use high level shader call.", ELL_WARNING);
}

bool COpenGLSLMaterialRendererOld::setVertexShaderConstant(s32 index, const f32* floats, int count)
{
	return setPixelShaderConstant(index, floats, count);
}

bool COpenGLSLMaterialRendererOld::setVertexShaderConstant(s32 index, const s32* ints, int count)
{
	return setPixelShaderConstant(index, ints, count);
}

bool COpenGLSLMaterialRendererOld::setPixelShaderConstant(s32 index, const f32* floats, int count)
{
#ifdef GL_ARB_shader_objects
...
bool COpenGLSLMaterialRendererOld::setPixelShaderConstant(s32 index, const s32* ints, int count)
{
#ifdef GL_ARB_shader_objects
	if (index < 0 || UniformInfo[index].location < 0)
		return false;
...
IVideoDriver* COpenGLSLMaterialRendererOld::getVideoDriver()
{
	return Driver;
}
