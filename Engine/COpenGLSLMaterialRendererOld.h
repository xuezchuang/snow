...
class COpenGLSLMaterialRendererOld : public IMaterialRenderer, public IMaterialRendererServices
{
public:

	//! Constructor
	COpenGLSLMaterialRendererOld(
		COpenGLDriverOld* driver,
	...
	//! Destructor
	virtual ~COpenGLSLMaterialRendererOld();
...
protected:
	...
	COpenGLSLMaterialRendererOld(COpenGLDriverOld* driver,
