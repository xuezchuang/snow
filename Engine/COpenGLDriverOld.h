...
class COpenGLDriverOld : public CNullDriver, public IMaterialRendererServices, public COpenGLExtensionHandler
{
public:
	...
	COpenGLDriverOld(const SIrrlichtCreationParameters& params, io::IFileSystem* io, IContextManager* contextManager);
#endif

#ifdef _IRR_COMPILE_WITH_SDL_DEVICE_
	COpenGLDriverOld(const SIrrlichtCreationParameters& params, io::IFileSystem* io, CIrrDeviceSDL* device);
#endif

	bool initDriver();

	//! destructor
	virtual ~COpenGLDriverOld();
	...
	COpenGLCacheHandlerOld* getCacheHandler() const;
...
private:
	...
	COpenGLCacheHandlerOld* CacheHandler;
