...
//! Constructor
COpenGLShaderMaterialRendererOld::COpenGLShaderMaterialRendererOld(video::COpenGLDriverOld* driver,
...
{
#ifdef _DEBUG
	setDebugName("COpenGLShaderMaterialRendererOld");
#endif
...
COpenGLShaderMaterialRendererOld::COpenGLShaderMaterialRendererOld(COpenGLDriverOld* driver,
...
//! Destructor
COpenGLShaderMaterialRendererOld::~COpenGLShaderMaterialRendererOld()
{
	if (CallBack)
		CallBack->drop();
...
void COpenGLShaderMaterialRendererOld::init(s32& outMaterialTypeNr,
...
bool COpenGLShaderMaterialRendererOld::OnRender(IMaterialRendererServices* service, E_VERTEX_TYPE vtxtype)
{
...
void COpenGLShaderMaterialRendererOld::OnSetMaterial(const video::SMaterial& material, const video::SMaterial& lastMaterial,
...
void COpenGLShaderMaterialRendererOld::OnUnsetMaterial()
{
...
bool COpenGLShaderMaterialRendererOld::isTransparent() const
{
...
bool COpenGLShaderMaterialRendererOld::checkError(const irr::c8* type)
{
...
bool COpenGLShaderMaterialRendererOld::createPixelShader(const c8* pxsh)
{
	if (!pxsh)
		return true;
...
bool COpenGLShaderMaterialRendererOld::createVertexShader(const c8* vtxsh)
{
	if (!vtxsh)
		return true;
