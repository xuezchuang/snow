...
//! constructor
CSceneNodeAnimatorCameraBlender::CSceneNodeAnimatorCameraBlender(gui::ICursorControl* cursor,
...
{
#ifdef _DEBUG
	setDebugName("CSceneNodeAnimatorCameraBlender");
#endif
...
//! destructor
CSceneNodeAnimatorCameraBlender::~CSceneNodeAnimatorCameraBlender()
{
	if (CursorControl)
		CursorControl->drop();
}
...
bool CSceneNodeAnimatorCameraBlender::OnEvent(const SEvent& event)
{
	...
	case EMIE_MOUSE_WHEEL:
		...
		iWheel += event.MouseInput.Wheel < 0 ? 1 : -1;
		break;
...
void CSceneNodeAnimatorCameraBlender::updateMousePos()
{
	if (CursorControl)
	{
		MousePos = CursorControl->getRelativePosition();
...
void CSceneNodeAnimatorCameraBlender::animateNode(ISceneNode* node, u32 timeMs)
{
...
bool CSceneNodeAnimatorCameraBlender::isMouseKeyDown(s32 key) const
{
	return MouseKeys[key];
}


void CSceneNodeAnimatorCameraBlender::allKeysUp()
{
	for (s32 i = 0; i < 3; ++i)
		MouseKeys[i] = false;
	bWheel = false;
...
void CSceneNodeAnimatorCameraBlender::setRotateSpeed(f32 speed)
{
	RotateSpeed = speed;
}
...
void CSceneNodeAnimatorCameraBlender::setMoveSpeed(f32 speed)
{
...
//! Sets the zoom speed
void CSceneNodeAnimatorCameraBlender::setZoomSpeed(f32 speed)
{
	ZoomSpeed = speed;
}
...
//! Set the distance
void CSceneNodeAnimatorCameraBlender::setDistance(f32 distance)
{
...
f32 CSceneNodeAnimatorCameraBlender::getRotateSpeed() const
{
	return RotateSpeed;
}
...
f32 CSceneNodeAnimatorCameraBlender::getMoveSpeed() const
{
...
//! Gets the zoom speed
f32 CSceneNodeAnimatorCameraBlender::getZoomSpeed() const
{
	return ZoomSpeed;
}
...
f32 CSceneNodeAnimatorCameraBlender::getDistance() const
{
	return CurrentZoom;
}

void CSceneNodeAnimatorCameraBlender::setTargetMinDistance(f32 minDistance)
{
...
f32 CSceneNodeAnimatorCameraBlender::getTargetMinDistance() const
{
	return TargetMinDistance;
}


ISceneNodeAnimator* CSceneNodeAnimatorCameraBlender::createClone(ISceneNode* node, ISceneManager* newManager)
{
	CSceneNodeAnimatorCameraBlender* newAnimator =
		new CSceneNodeAnimatorCameraBlender(CursorControl, RotateSpeed, ZoomSpeed, TranslateSpeed);
	newAnimator->cloneMembers(this);
	return newAnimator;
}

void CSceneNodeAnimatorCameraBlender::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
...
void CSceneNodeAnimatorCameraBlender::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options)
{
