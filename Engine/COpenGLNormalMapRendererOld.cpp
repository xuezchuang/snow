...
//! Constructor
COpenGLNormalMapRendererOld::COpenGLNormalMapRendererOld(video::COpenGLDriverOld* driver,
	...
	: COpenGLShaderMaterialRendererOld(driver, 0, baseMaterial), CompiledShaders(true)
{
...
#ifdef _DEBUG
	setDebugName("COpenGLNormalMapRendererOld");
#endif
	...
	if (renderer)
	{
		...
		video::COpenGLNormalMapRendererOld* nmr = reinterpret_cast<video::COpenGLNormalMapRendererOld*>(renderer);
...
//! Destructor
COpenGLNormalMapRendererOld::~COpenGLNormalMapRendererOld()
{
	if (CallBack == this)
		CallBack = 0;
...
s32 COpenGLNormalMapRendererOld::getRenderCapability() const
{
	if (Driver->queryFeature(video::EVDF_ARB_FRAGMENT_PROGRAM_1) &&
		Driver->queryFeature(video::EVDF_ARB_VERTEX_PROGRAM_1))
		return 0;
...
void COpenGLNormalMapRendererOld::OnSetConstants(IMaterialRendererServices* services, s32 userData)
{
