...
constexpr auto IRRLICHT_VERSION_MAJOR = 1;
constexpr auto IRRLICHT_VERSION_MINOR = 9;
constexpr auto IRRLICHT_VERSION_REVISION = 0;
// This flag will be defined only in SVN, the official release code will have
// it undefined
#define IRRLICHT_VERSION_SVN alpha
constexpr auto IRRLICHT_SDK_VERSION = "1.9.0";
