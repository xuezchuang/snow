...
class COpenGLShaderMaterialRendererOld : public IMaterialRenderer
{
public:

	//! Constructor
	COpenGLShaderMaterialRendererOld(COpenGLDriverOld* driver,
								  s32& outMaterialTypeNr, const c8* vertexShaderProgram, const c8* pixelShaderProgram,
								  IShaderConstantSetCallBack* callback, E_MATERIAL_TYPE baseMaterial, s32 userData);

	//! Destructor
	virtual ~COpenGLShaderMaterialRendererOld();
