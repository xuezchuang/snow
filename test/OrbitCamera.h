...
public:
    ...
    void moveTo(const Vector3& to, float duration=0);
    void moveForward(float delta, float duration=0);
    ...
    void shiftTo(const Vector3& to, float duration=0);
    void shift(const Vector2& delta, float duration=0);
    ...
    void rotateTo(const Vector3& angle, float duration=0.0f);
    void rotateTo(const Quaternion& quat, float duration=0.0f);
    void rotate(const Vector3& deltaAngle, float duration=0.0f);
    ...
    void getRotation(Vector3& v); // angles in degree
