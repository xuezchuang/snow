...
bool initApp() 
{
    ...
    // shaders
    //
    if (!gSimpleWater.mSurfaceShader.Compile("shaders/renderSurface.vs", "shaders/renderSurface.fs"))
    {
        return false;
    }

    if (!gSimpleWater.mDebugShader.Compile("shaders/renderSurfaceDebug.vs", "shaders/renderSurfaceDebug.fs"))
    {
        return false;
    }
