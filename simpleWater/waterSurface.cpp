...
{
    if (!mDrawShader.Compile("shaders/waterPassThrough.vs", "shaders/waterDraw.fs"))
    {
        return false;
    }

    if (!mComputeShader.Compile("shaders/waterPassThrough.vs", "shaders/waterUpdate.fs"))
    {
        return false;
    }
    ...
    if (!mComputeNormalsShader.Compile("shaders/waterPassThrough.vs", "shaders/waterUpdateNormals.fs"))
    {
        return false;
    }
